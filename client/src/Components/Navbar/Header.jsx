...
const Header = () => {
    ...
    return sessionStorage.getItem("uuid") == 14 ? (
            ...
            <div className="h-100 d-flex flex-row justify-content-end col-3 align-items-center" style={{ height: "40px" }}>
                ...
                <div className="d-flex flex-row align-items-center">
                    <li className="nav-item nav-link ">
                        <button type="button" className="btn btn-primary btn-sm nav-item" data-bs-toggle="modal" data-bs-target="#loginModal">
                            Login
                        </button>
                ...
                <li className="nav-item nav-link ">
                    <button type="button" className="btn btn-primary btn-sm nav-item" data-bs-toggle="modal" data-bs-target="#registerModal">
                        Register
                    </button>
